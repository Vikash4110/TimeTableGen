...
// import React, { useState, useEffect } from "react";
// import { motion, AnimatePresence } from "framer-motion";
// import { FaPlus, FaSearch, FaUserGraduate, FaTimes, FaComments, FaEdit } from "react-icons/fa";
// import { toast } from "sonner";
// import { useDebounce } from "use-debounce";
// import { GoogleGenerativeAI } from "@google/generative-ai";
...
//         // Check if the response contains a project prediction
...
//               Class: <span className="font-medium">{student.classGrade}-{student.section}</span>
//             </p>
//             {student.project && student.project.title && (
//               <p className="mt-2">
//                 <span className="font-medium text-indigo-600">Your Project Assigned:</span>{" "}
//                 {student.project.title} - {student.project.description}
//               </p>
//             )}
//           </div>
//         </div>
...
//             title={student.project.title ? "Update Project" : "Get Project Recommendation"}
//           >
//             {student.project.title ? <FaEdit className="w-5 h-5" /> : <FaComments className="w-5 h-5" />}
//           </button>
//         </div>
//       </div>
//     </motion.div>
...
//                     ? `Update Project for ${selectedStudent.name}`
//                     : `Project Assistant for ${selectedStudent.name}`}
//                 </h2>
//                 <button onClick={closeChat} className="text-white hover:text-indigo-200">
//                   <FaTimes className="w-5 h-5" />
...
//                   <div className="text-gray-500 text-center">
//                     {selectedStudent.project.title
//                       ? "Let’s update your project—tell me what you’d like to change!"
//                       : "Let’s find a project for you—start by telling me what you like!"}
//                   </div>
//                 )}
//                 {chatMessages.map((message, index) => (
