...
//     setLoading(true);
//     try {
//       const response = await fetch(`${backendUrl}/api/students/forgot-password`, {
//         method: 'POST',
//         headers: { 'Content-Type': 'application/json' },
...
//     setLoading(true);
//     try {
//       const response = await fetch(`${backendUrl}/api/students/reset-password`, {
//         method: 'POST',
//         headers: { 'Content-Type': 'application/json' },
//         body: JSON.stringify({
...
//           >
//             {forgotPassword ? 'Reset Password' : 'Child Login'}
//           </motion.h2>
...
//               <motion.button
//                 type='submit'
//                 className={`py-3 px-6 rounded-full font-semibold text-white w-2/3 mx-auto flex justify-center items-center bg-gradient-to-r from-blue-600 to-purple-500 hover:from-blue-700 hover:to-purple-600 transition-all duration-300
